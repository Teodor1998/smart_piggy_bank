...
// Portul la care conectam pinu-ul pentru backlight
#define LcdBacklight_DDR        DDRC
#define LcdBacklight_PORT       PORTC
#define LcdBacklight_PIN        PINC

// Pinul ce controleaza backlight-ul
#define LcdBacklight            PC2
...
#define LCD_INSTR_displayConfig 0x0c    // display pornit, fara cursor afisat, fara blink activat
